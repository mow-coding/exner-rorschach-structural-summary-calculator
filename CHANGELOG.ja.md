...
| 日付 | バージョン | 種別 | リリースノート | サービス |
| --- | --- | --- | --- | --- |
| 2026-09-24 | v3.0.0 | メジャーリリース | [リリースノート](./v3-web/releases/v3.0.0/README.ja.md) · [モデル比較](./v3-web/benchmarks/2026-09-23/) · [公開設定の検証](./v3-web/benchmarks/2026-09-24/) | [exner.app](https://exner.app) |
