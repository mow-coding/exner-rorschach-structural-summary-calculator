...
El flujo con proveedor simulado completó 13 solicitudes de chat, 13 inserciones de búsqueda, 2 resúmenes y 13 generaciones. En `exner.app`, cuentas sintéticas completaron **una respuesta de codificación y una de interpretación**; dos búsquedas y dos generaciones costaron **US$0.000892** según uso y precios configurados. También se creó una pantalla de pago Live con una cuenta sintética. Dos respuestas de producción no establecen un promedio de calidad o costo por respuesta útil.
