...
Se ha aplicado la versión menor 1.4.0.

> **Se añadió soporte multilingüe.**
>
- Se admiten cinco idiomas: coreano, inglés, japonés, español y portugués.

    Un botón de idioma (🌐) en la parte superior derecha de la aplicación web permite cambiar de idioma en cualquier momento.

- Todos los textos de la interfaz, los mensajes de los modales, las indicaciones, las advertencias de slots y el texto del pie de página se tradujeron a los cinco idiomas.
- Todas las descripciones de elementos de la pestaña Más se tradujeron a los cinco idiomas.
...
### *Soporte multilingüe añadido*

Se añadió a la aplicación web el soporte de cinco idiomas (coreano, inglés, japonés, español, portugués),

y se tradujo todo el texto de la interfaz.

> **Botón de idioma**
>
- Botón con icono de globo (🌐) añadido en la parte superior derecha de la aplicación web
- Al cargar la página, JavaScript añade la clase `language-selector-collapsed` para mostrar el botón
- El botón de idioma se muestra por encima del modal inicial aunque esté abierto (z-index: 10001 > 1000)
- El botón de idioma sigue visible después de cerrar el modal inicial
- Al pasar el ratón se muestran las opciones de idioma (한국어, English, 日本語, Español, Português)
- El idioma elegido se guarda en el almacenamiento local y se mantiene en la siguiente visita

> **Detalles técnicos**
>
- Estructura de los datos de traducción

    ---

    - Objeto `translations`: traducciones del texto básico de la interfaz (201 entradas)

        ---

        - Elementos básicos de la aplicación (app_title, tab_scoring, tab_notice)
        - Texto de los botones (btn_calc, btn_reset, btn_add, btn_del)
        - Modal de primer acceso (modal_welcome_title, modal_welcome_new, modal_welcome_load, modal_welcome_provider, etc.)
        - Modal de confirmación de restablecimiento (modal_reset_title, modal_reset_msg, modal_reset_yes, modal_reset_no)
        - Modal de solicitud de interpretación por IA (modal_ai_title, modal_ai_msg, modal_ai_open, modal_ai_cancel)
        - Enlaces y otros (link_manual, link_bug, link_patch, link_lab, link_privacy)
        - Política de privacidad (privacy_title, privacy_notice_title, privacy_notice_text)
        - Mensajes de orientación (list_header, loader_calc, loader_sub, guide_response, tooltip_info)
        - Pestañas y botones de la pantalla de resultados (tab_upper, tab_lower, tab_special, btn_rawdata, btn_summary, btn_print, btn_ai)
        - Etiquetas de las casillas de Special Indices (scon_main, scon_note, depi_main, cdi_main, hvi_main, obs_main, obs_r1, obs_r2, obs_r3)
        - Mensajes de advertencia de slots (toast_warning_over_scoring, toast_warning_category_dup, toast_warning_hierarchy, toast_warning_too_many_responses, toast_warning_validity, toast_info_reset y el texto de cada mensaje)
        - Texto del pie de página (footer_title, footer_copyright)

    - Objeto `listTranslations`: traducciones de las descripciones de elementos de la pestaña Más

        ---

        - `category`: nombres de categorías (10 categorías)
        - `categoryDesc`: descripciones de categorías (10 categorías)
        - `items`: descripciones de elementos individuales (106 elementos)
...
- Actualización dinámica del texto
    ...
    - Función `changeLanguage()`: actualiza dinámicamente todo el texto de la interfaz al cambiar de idioma
    - Función `updateAllTexts()`: actualiza todos los elementos de texto según el idioma seleccionado
    - Función `generateListTable()`: regenera la tabla de la pestaña Más en el idioma actual
    - Función `updateLanguageButtons()`: actualiza el estado activo de los botones de idioma

- Funciones de traducción

    ---

    - `t(key)`: recibe una clave de traducción y devuelve el texto del idioma actual
    - `getTranslatedCategoryName()`: obtiene la traducción del nombre de la categoría
    - `getTranslatedCategoryDescription()`: obtiene la traducción de la descripción de la categoría
    - `getTranslatedItemDescription()`: obtiene la traducción de la descripción del elemento


### *Estado de la traducción y comparación por idioma*

Todos los elementos de la interfaz y las descripciones de la pestaña Más están completamente traducidos a los cinco idiomas.
...
> | --- | --- | --- |
> | **Texto básico de la interfaz** | 45 | 45 |
> | **Pestañas/botones de resultados** | 7 | 7 |
> | **Etiquetas de casillas** | 9 | 9 |
> | **Mensajes de advertencia de slots** | 12 | 12 |
> | **Texto del pie de página** | 2 | 2 |
> | **Nombres de categorías** | 10 | 10 |
> | **Descripciones de categorías** | 10 | 10 |
> | **Descripciones de elementos** | 106 | 106 |
> | **Total** | **201** | **201** |
>
...
> >
> >
> > | Idioma | Hecho | Completitud |
> > | --- | --- | --- |
> > | **Coreano (ko)** | 201 | 100% ✅ |
> > | **Inglés (en)** | 201 | 100% ✅ |
> > | **Japonés (ja)** | 201 | 100% ✅ |
> > | **Español (es)** | 201 | 100% ✅ |
> > | **Portugués (pt)** | 201 | 100% ✅ |
> >
> > ✅ **La traducción está completa en todos los idiomas.**
> >

### *Comparación de traducciones de los elementos principales de la interfaz por idioma*

Si alguna traducción es insuficiente, comuníquelo; se corregirá.

> **Elementos básicos de la aplicación**
>

| Clave | Coreano (ko) | Inglés (en) | Japonés (ja) | Español (es) | Portugués (pt) |
| --- | --- | --- | --- | --- | --- |
...
> **Modal de solicitud de interpretación por IA**
>
...
> **Pestañas y botones de la pantalla de resultados**
>
...
> **Etiquetas de las casillas de Special Indices**
>
...
> **Mensajes de advertencia de slots**
>
...
> **Nombres de categorías de la pestaña Más**
>

| Clave de categoría | Coreano (ko) | Inglés (en) | Japonés (ja) | Español (es) | Portugués (pt) |
| --- | --- | --- | --- | --- | --- |
...
> **Descripciones de categorías y de elementos de la pestaña Más**

Todas las descripciones de categorías (10) y de elementos (106) de la pestaña Más están traducidas a los cinco idiomas.
>
- **Descripciones de categorías (10)**

    ---

    | Categoría | Coreano (ko) | Inglés (en) | Japonés (ja) | Español (es) | Portugués (pt) |
    | --- | --- | --- | --- | --- | --- |
...
- **Card (10 elementos)**
    ...
    | Código del elemento | Coreano (ko) | Inglés (en) | Japonés (ja) | Español (es) | Portugués (pt) |
    | --- | --- | --- | --- | --- | --- |
...
> **Atributos title**
>
- **Botones de idioma**: atributos `title` del botón con icono de globo y de cada botón de idioma
- **Botones de exportación CSV**: atributos `title` de los botones "Raw Data" y "Summary"
- **Botones de control de slots**: atributos `title` de los botones "+" y "-" del área de puntuación

| Clave | Coreano (ko) | Inglés (en) | Japonés (ja) | Español (es) | Portugués (pt) |
| --- | --- | --- | --- | --- | --- |
| `title_select_language` | 언어 선택 | Select Language | 言語を選択 | Seleccionar Idioma | Selecionar Idioma |
- `title_lang_ko`, `title_lang_en`, `title_lang_ja`, `title_lang_es`, `title_lang_pt`: title de cada botón de idioma
- `title_export_rawdata`: title del botón de exportación CSV (Raw Data)
- `title_export_summary`: title del botón de exportación CSV (Summary)
- `title_add_slot`: title del botón de añadir slot
- `title_delete_slot`: title del botón de eliminar slot

### *Mejora del estilo de la pestaña Más*

Para resolver el desbordamiento de la tabla por textos largos en la pestaña Más, se hicieron los siguientes cambios

- **Sin saltos de línea**: se eliminaron `word-wrap`, `word-break` y `overflow-wrap`; se aplicó `white-space: nowrap`
- **Ancho de cabecera**: se eliminó `table-layout: fixed`; se estableció `min-width: 800px` en la tabla
- **Desplazamiento horizontal**: se añadió `overflow-x: auto` a `.table-wrapper:has(#list-table-body)`
- **Celdas de descripción**: se mantiene `white-space: normal` para que las descripciones largas puedan saltar de línea

### *Mejora de la calidad del código*

Se eliminaron comentarios en línea innecesarios y se mejoró la coherencia del índice y de los comentarios.

- Comentarios en línea ordenados
- Coherencia del índice y de los comentarios

---

# Hoja de ruta

Se está considerando incluir anuncios de banner en la próxima versión mayor.
